...
<Tip>
  Wrap iframes in a [`<Frame>`](/components/frames) component to keep them aligned with the text column. Unwrapped iframes can overflow the content area, especially on narrower screens.
</Tip>
