...
<Tip>
  Wrap iframes in a `<Frame>` component to keep embedded content constrained to the text column and prevent horizontal overflow. The YouTube embed example above uses this pattern.
</Tip>
