...
<Note>
  Some Mintlify features are not available in headless projects because they depend on Mintlify's hosted rendering layer. Notably, the **API playground**, **web editor**, **authentication and password protection**, **user feedback**, **preview deployments**, and **PDF export** are not available. Expand the table below for the full list.
</Note>
