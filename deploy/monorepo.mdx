...
The monorepo configuration lives in your Mintlify dashboard, not in `docs.json`. You enable it on the same project that's connected to your repository, whether the project is new or already deployed from the repository root.

<Steps>
<Step title="Access Git settings">
In your dashboard, go to **Settings** > **Deployment** > **Git settings**, or open [Git Settings](https://dashboard.mintlify.com/settings/deployment/git-settings) directly. The **Set up as monorepo** toggle is on this page.
