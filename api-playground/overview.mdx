...
keywords: ["API playground", "interactive API", "API", "endpoint testing", "live API requests", "request builder", "try it", "API explorer"]
boost: 3
---

The API playground is an interactive environment in your documentation that lets users test and explore your API endpoints. Developers can craft API requests, submit them, and view responses without leaving your documentation.

The playground is generated automatically from an OpenAPI specification or AsyncAPI schema, or you can author endpoint pages manually in MDX. It is part of the broader API reference experience and is what users mean when they ask about an "API playground", "Try it" panel, or interactive API reference in Mintlify.
