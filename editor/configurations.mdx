...
Set your site's identity and how it appears to visitors. For the equivalent `docs.json` fields, see [Settings](/organize/settings).
...
Control your site's visual identity and color scheme. Learn more about [themes](/customize/themes) and [appearance settings](/organize/settings-appearance).
...
Replace default fonts with your brand's typography. Learn more about [custom fonts](/customize/fonts).
...
Add navigation elements to the top of your site. For the equivalent `docs.json` fields, see [Navigation](/organize/navigation).
...
Add links and social media handles to your site footer. For the equivalent `docs.json` fields, see [Navigation](/organize/navigation).
...
Connect third-party tools for analytics, support, and compliance. See the [analytics integrations overview](/integrations/analytics/overview) for the full list of supported providers.

## API specifications

Document your API endpoints. Learn more in the [API playground overview](/api-playground/overview).
